...
throw new \Exception("Nao foi possveil recuperar a sena");
...
else
{
   ...
   $mailer = new Mailer($data["desemail"],$data["desperson"],"redefnir senhhaaa","forgot",
   array(
           "name"=>$data["desperson"],
            "link"=>$link
   ));
...
public static function validForgotescrypt($result)
{
